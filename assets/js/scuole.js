...
// @codekit-append "../../bower_components/jquery.scrollTo/jquery.scrollTo.js";
// @codekit-append "../../bower_components/jquery.breakpoints/breakpoints.js";
...
// @codekit-append "../../components/ResponsiveMultiLevelMenu/js/jquery.dlmenu.js";
...
// @codekit-append "../../components/sticky-kit-master/dist/sticky-kit.js";
...
$(window).bind('exitBreakpoint1200',function() {
	$('#log').append('<p>Exiting 1200 breakpoint</p>');
});
$(window).bind('enterBreakpoint1200',function() {
	$('#log').append('<p>Entering 1200 breakpoint</p>');
}); */

/* Responsive DOM */
var $movenav = $('.nav-list');
...
/* Main Menu */
$(document).ready(function() {
  if ($(".nav-container .nav-list").length) {
    $(".nav-container .nav-list .toggle-dropdown").on("click", function(e){
...
/* $(document).ready(function() {
  if ($(".accordion-wrapper").length) {
    ...
    if (window_width < 1200) {
      ...
      $('.accordion-header').removeClass('accordion-inactive');
      $('.accordion-header').removeClass('accordion-active');
      $('.accordion-content').removeClass('accordion-closed');
