...
/**
 * Template Name: Archivio Struttura
 * 
...
<main id="main-container" class="main-container redbrown">
    <?php
    get_template_part("martini-template-parts/hero/hero_strutture");
                            ...
                            ?>
                                <div class="title-section mb-5">
                                    <h3 class="h4"><a href="<?php echo get_term_link($tipologia_struttura); ?>">
                                            <?php if (count($strutture) > 1) echo dsi_pluralize_string($tipologia_struttura->name);
                                            else echo $tipologia_struttura->name; ?>
                                        </a>
                                    </h3>
                                </div><!-- /title-large -->
                                ...
                                ?>
                                    ...
                                    <div class="title-section mb-5">
                                        <h3 class="h4"><a href="<?php echo get_term_link($tipologia_struttura); ?>"><?php if (count($strutture) > 1) echo dsi_pluralize_string($tipologia_struttura->name);
                                                                                                                    else echo $tipologia_struttura->name; ?></a>
                                        </h3>
                                    </div><!-- /title-large -->
