...
<main id="main-container" class="main-container">
    ...
    <section id="container-carte-della-scuola" class="px-5">
        <div class="row">
    ...
    <section class="row bg-light px-5">
        <div class="col-12 col-md-6">
            <h4 class="">Privacy</h4>
        </div>
        <div class="col-12 col-md-6 align-items-start text-md-right">
        ...
        <div class="align-items-center row col-12 m-0">
            ...
            ?>
                <div class=" col-3 text-center mb-4">
                    <a class="mt-3" href="<?php echo array_values($privacy)[0]; ?>">
    ...
    <section class="row bg-light px-5" id="container-sicurezza">
        ...
        <div class="align-items-center row col-12 m-0">
            ...
            while ($loop->have_posts()) : $loop->the_post('sicurezza');
                ...
                $sicurezza = get_post_meta(get_the_ID(), '_martini_sicurezza_file_sicurezza', true);
