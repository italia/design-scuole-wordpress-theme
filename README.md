...
Questo sito permette di capire com’è organizzata la scuola, quali percorsi di studio mette a disposizione e quali servizi di supporto alla didattica sono disponibili per la comunità scolastica. Si pone l’obiettivo di comunicare in modo chiaro e semplice l’identità di una scuola, riducendo il peso della burocrazia (naturalmente nel rispetto degli obblighi), dando spazio ai contenuti e alle persone e cercando di ricostruire anche on line l’atmosfera che caratterizza la vita di una scuola.


#### Creare con cura i principali contenuti
Il tema è un modello **“chiavi in mano”**: all’attivazione sono infatti state già definite le aree, le voci di menu e, più in generale, l’architettura ideale di un sito di una scuola. Quindi, a differenza di come a volte  si lavora su WordPress, non ci si deve interessare di come verranno presentati i contenuti, di cosa finirà in homepage o in altre sezioni del sito.
Il tema comporrà le diverse pagine sulla base dei contenuti inseriti. In questo modello il compito principale del redattore è quello di creare i contenuti, sfruttando il più possibile tutti i campi già predisposti per ogni tipologia di contenuto (content type). L’idea generale è che una scuola possa risparmiare tempo nel progettazione e realizzazione del proprio sito (il sito è pronto!) e possa dedicare più tempo a comunicare con precisione e semplicità cosa una scuola fa e come è organizzata.  
...
Per creare i contenuti del nuovo sito e imparare a gestirlo sarà utile creare un piccolo gruppo di lavoro composto da personale tecnico amministrativo e docenti. La creazione di un team è importante soprattutto per mappare le informazioni necessarie prima della fase di scrittura vera e propria (Per esempio, questo sito fa lo sforzo di spiegare i servizi della scuola in modo semplice e questo richiede un lavoro preliminare per chiarire come sono fatti e come funzionano i servizi). Il gruppo di lavoro così creato dovrà porsi l’obiettivo di creare questi contenuti ed aggiornarli quando necessario

#### e a seguire

Un discorso a sé stante è da riservare alle:
- notizie
- eventi 
- circolari 
- eventi
...
- progetti scolastici
- schede didattiche. 
In una fase iniziale la cosa migliore è creare un solo esempio per ciascuna tipologia, per poi creare mano a mano i contenuti quando il sito sarà on line, sulla base di ciò che è attuale in quel momento. 
...
#### Riscrivere o importare i vecchi contenuti

Sulla base di  come sono fatti normalmente i siti delle scuole, la cosa migliore è riscrivere interamente tutti i contenuti relativi ai luoghi, alle strutture, ai servizi, alle persone, ai percorsi di studio e ai progetti

Notizie ed eventi di solito non sono più attuali, quindi non serve portarli sul nuovo sito

Potrebbe essere utile importare documenti e circolari dal vecchio al nuovo sito, utilizzando lo strumento di import/export nativo di Wordpress e verificando che il risultato finale sia soddisfacente (molto dipende da come sono stati scritti nel sito precedente). Il tema tenterà  una riconciliazione automatica delle tipologie di contenuto più frequentemente usate dalle scuole che utilizzano Wordpress: come gli eventi, le circolari e i documenti di amministrazione trasparente.

#### Relazioni tra i contenuti
Una delle caratteristiche di questo sito modello è il fatto di di avere diverse tipologie di contenuto (content type), tutte in relazione tra loro. Questa impostazione richiede un po’ di rigore nella fase iniziale, ma poi porta benefici sia per chi deve gestire e aggiornare i contenuti, sia per gli utenti che ricercano informazioni. Per esempio, abbiamo creato una relazione tra i luoghi in cui ha sede la scuola, l’organizzazione scolastica (le diverse aree in cui la scuola è organizzata) e i servizi che la scuola offre.


Dal punto di vista pratico, soprattutto all’inizio, ti troverai nella situazione in cui 
1. crei la scheda che descrive una struttura (es. segreteria)
2. dovrai associare i luoghi in cui la segreteria ha sede. Prima di farlo, però, dovrai aver compilato le schede luogo (es. le schede di due diversi edifici che fanno parte della scuola) da associare alla scheda che descrive la segreteria
3. dovrai associare i servizi che la segreteria offre. Prima di farlo, però, dovrai aver compilato le schede dei servizi che offre la segreteria (es. delega per il ritiro dei bambini della scuola primaria) da associare alla scheda che descrivere la segreteria.
Dopo aver fatto questo lavoro, la scheda della segreteria mostrerà i luoghi dove la segreteria ha sede e i servizi che offre, cioè tutte informazioni che ci servono quando ci rivolgiamo alla segreteria scolastica.

Nella maggior parte dei casi questa correlazione è bidirezionale e automatica (se creo una relazione tra un luogo e una struttura, questa relazione verrà mostrata sia nel dettaglio del luogo che in quello della struttura), in altri è necessario tornare alla scheda iniziale per inserire la relazione con l’elemento appena creato.
...
La struttura organizzativa è uno degli elementi essenziali nella presentazione dell’istituto. In caso di istituti comprensivi è necessario creare in primo luogo la struttura “Genitore” di tipo “Scuola” (l’istituto stesso) e altre strutture “figlie” (i singoli plessi). Nella scheda della singola struttura va indicato il luogo o i luoghi in cui ha sede.
Oltre ai plessi sono strutture organizzative anche le commissioni, gli uffici di segreteria, i dipartimenti, gli organi collegiali…
...
Consigliamo di mappare e creare il prima possibile le utenze delle persone, così da poterle subito correlare con i contenuti inseriti. 

È necessario farlo anche se queste non avranno un ruolo attivo sul sito, creando le utenze senza inviare loro la mail con le credenziali di accesso (possono essere inviate eventualmente in seguito)  

In questo modo tutto il personale scolastico avrà inoltre la possibilità di produrre contenuti (quando necessario), ricevere notifiche personalizzate relative alla circolari oltre ad altre funzionalità.
...
In questa sezione vanno caricati anche i documenti che hanno come destinazione l’albo on line o la sezione di amministrazione trasparente. I documenti in albo hanno una numerazione progressiva non modificabile e una volta pubblicati possono solo essere annullati.

I documenti sono poi richiamabili nei diversi content type del sito, quando necessario. E’ sempre consigliabile creare schede documenti piuttosto che caricare i file direttamente dentro i content type, così da renderli più facilmente ricercabili e indicizzabili dai motori di ricerca

**I progetti**

il content type “scheda progetto” serve a raccontare i risultati di un'attività svolta insieme agli studenti all'interno della scuola o nell'ambito di una uscita didattica, nell'ambito della didattica tradizionale o di attività ad essa complementari.

**Le schede didattiche**

Approfondimento tematico a cura di uno o più insegnanti. La scheda è rivolta agli studenti.

Nel content type “scheda didattica” è inoltre possibile definire il collegamento delle schede didattiche con i luoghi, le strutture e i documenti della scuola

**Le notizie**

Le notizie sono rappresentati dal content type “post”, nativo di Wordpress. Queste sono organizzate per tipologia (news e articoli sono le 2 tipologie create all’attivazione del tema), e sono utili a organizzare le notizie nella pagina di presentazione generale, o per filtrare le notizie per tipologia nelle pagine di archivio. 
...
1. L'insegnante riempie una scheda circolare
2. Invio la scheda alla segreteria
3. la segreteria la mostra al preside
4. il preside la legge ed apporta, eventualmente, delle modifiche, Poi la firma.
5. la segreteria protocolla la circolare
6. la segreteria invia la circolare a tutti i docenti (o a tutta la scuola) che riceverà una notifica nella propria area personale
