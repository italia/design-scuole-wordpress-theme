    ...
    <section id="image-block">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 order-md-1">
                <img src="<?php echo get_template_directory_uri () ?>/assets/placeholders/placeholder-1000x665.jpg" alt="">
            </div>
        </div>
    </section>

    <section id="image-block-reverse">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6" style="background-color: purple;">
                <img src="" alt="">
            </div>
        </div>
    </section>
