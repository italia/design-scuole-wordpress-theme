...
function printUl($data){
	echo '<li><a href="' . get_term_link( get_term_by('name', $data[0], 'amministrazione-trasparente'), 'amministrazione-trasparente' ) . '" title="' . $data[0] . '">'.$data[0].'<span class="counterA text-danger"> ('.$data["count"].')</span></a>';
	echo "<ul>";
