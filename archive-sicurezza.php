...
?>
    <main id="main-container" class="main-container">
        ...
        <section id="container-spazi">
            <details>
                <summary><h4>Sicurezza della scuola</h4></summary>
                <?php 
                    ...
                    while ($loop -> have_posts()) : $loop -> the_post( $sicurezza ); ?>
                        ...
                        <article class="mx-5 my-5">
                            ...
                            <div class="row">
                                <div class="col-2  text-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
