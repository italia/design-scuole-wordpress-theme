...
<main id="main-container" class="main-container redbrown">
    ...
    <?php get_template_part("martini-template-parts/hero/hero_archive_doc"); ?>
                        ...
                        <div class="container">
                            ...
                            ?>
                                <div class="title-section mb-5">
                                    <h2 class="h4">
                                        <?php if (is_array($documenti) && count($documenti) > 1) echo dsi_pluralize_string($tipologia_documento->name);
                                        else echo $tipologia_documento->name; ?>
                                    </h2>
                                </div><!-- /title-section -->
