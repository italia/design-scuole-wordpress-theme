...
/**
 * Definisce post type per gli orari delle palestra
 */

add_action( 'init', 'register_orario_palestra_post_type' );
function register_orario_palestra_post_type() {

	/** Orari palestra **/
	$labels = array(
		'name'          => _x( 'Orari Palestra', 'Post Type General Name', 'martino_martini' ),
		'singular_name' => _x( 'Orario Palestra', 'Post Type Singular Name', 'martino_martini' ),
	...
	$args   = array(
		'label'         => __( 'Orari Palestra', 'martino_martini' ),
		'labels'        => $labels,
	...
	register_post_type( 'orario-palestra', $args );
...
add_action( 'cmb2_init', 'martini_add_orario_palestra_metaboxes' );
function martini_add_orario_palestra_metaboxes() {

    $prefix = '_martini_orario_palestra_';
    
    $cmb_aftercontent = new_cmb2_box( array(
    'id'           => $prefix . 'box_elementi_dati',
    'title'        => __( 'Orario palestra', 'martino_martini' ),
    'object_types' => array( 'orario-palestra' ),
    'context'      => 'normal',
    'priority'     => 'high',
    ) );
    ...
    $cmb_aftercontent->add_field( array(
        'id' => $prefix . 'file_orario_palestra',
        'name'    => __( 'Carica file', 'martino_martini' ),
        'desc' => __( 'File orario palestra' , 'martino_martini' ),
        'type' => 'file_list',
