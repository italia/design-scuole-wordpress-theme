...
?>
    <main id="main-container" class="main-container">
        ...
        <section id="container-privacy" class="container mt-3 mb-5">
            <div class="row mx-2">
                <h2 class="col-12 my-3"> Documenti PNRR</h2>
                <?php 
                    ...
                    while ($loop -> have_posts()) : $loop -> the_post( 'pnrr' ); 

                    $prefix = '_martini_pnrr_';

                    $documenti_istituto = get_post_meta( get_the_ID(), $prefix . 'file_pnrr', true );

                    ?>
                        <article class="col-12 my-2 px-4">
                            <div class="row align-items-center">
                                    <a href="<?php echo array_values($documenti_istituto)[0];?>" target="_blank">
