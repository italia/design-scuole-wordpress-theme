...
?>
    <section class="section bg-greendark bg-greendarkgradient py-5 position-relative d-flex align-items-center" style="min-height: 360px;">
            ...
            <div class="row variable-gutters">
                <div class="col-md-5">
                    <div class="hero-title text-left">
                        ...
                        <p class="h4 font-weight-normal"><?php echo $testo_notizie; ?></p>
                    </div><!-- /hero-title -->
                </div><!-- /col-md-5 -->
            </div><!-- /row -->
        </div><!-- /container -->
