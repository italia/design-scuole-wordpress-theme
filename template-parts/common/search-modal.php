						...
						<div class="row variable-gutters">
							<div class="col">
								...
								<div class="form-group search-form">
									...
									<input type="text" name="s" id="search-input" data-crawler="search-modal-input" class="form-control" aria-describedby="search-form" placeholder="<?php _e("Cerca informazioni, servizi, notizie o documenti","design_scuole_italia"); ?>" value="<?php echo get_search_query(); ?>">
