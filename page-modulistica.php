...
<main id="main-container" class="main-container my-5">
    ...
    <section class="container my-3">
        ...
        while ($loop->have_posts()) : $loop->the_post('modulistica');

            $modulistica = get_post_meta(get_the_ID(), '_martini_modulistica_file_modulistica', true);

        ?>
            <article>
                <div class="row mt-3 ml-4 align-items-center">
                    <a href="<?php echo array_values($modulistica)[0]; ?>">
