...
function dsi_add_luogo_metaboxes() {
	...
	$cmb_aftercontent_luoghi->add_field( array(
		...
		'desc'       => __( 'Galleria di immagini e video. I video verranno mostrati con un\'immagine di copertina, da impostare tramite la sezione "Media" di WordPress (se non presente verrà usata la copertina del luogo).', 'design_scuole_italia' ),
		'type' => 'file_list',
