...
//			'tilelayer'           => 'http://{s}.tile.osm.org/{z}/{x}/{y}.png',
	...
	$cmb_undercontent->add_field( array(
		...
		'desc'       => __( 'Galleria di immagini e video. I video verranno mostrati con un\'immagine di copertina, da impostare tramite la sezione "Media" di WordPress e scegliendo un\'immagine in evidenza (se non presente verrà usata l\'immagine in evidenza dell\'evento).', 'design_scuole_italia' ),
		'type' => 'file_list',
