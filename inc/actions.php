...
function dsi_admin_bar_customize_header() {
    ...
    $wp_admin_bar->add_menu(
        array(
            'id'     => 'design-scuole',
            'title' => '<span class="dsi-icon"><img class="martini-admin-logo" src="'
                . get_bloginfo('stylesheet_directory') 
                . '/assets/images_martini/logo-custom.png"/>'
                . '</span><span class="screen-reader-text">' . __( 'About Design Scuole' ) . '</span>',
            'href'   => '#'
        )
    );
